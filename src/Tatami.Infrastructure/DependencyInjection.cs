...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IPixBrCodeGenerator, PixBrCodeGenerator>();
        services.AddScoped<IFinancialExportWriter, FinancialExportWriter>();
        services.AddScoped<IFinancialNotificationSender, StubFinancialNotificationSender>();
